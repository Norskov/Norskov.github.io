...
/** @type {string} */
const CACHE_VERSION = '1718196586|11493650119';
/** @type {string} */
const CACHE_PREFIX = 'Hexgen-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'hexgen.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["hexgen.html","hexgen.js","hexgen.offline.html","hexgen.icon.png","hexgen.apple-touch-icon.png","hexgen.worker.js","hexgen.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["hexgen.wasm","hexgen.pck"];
